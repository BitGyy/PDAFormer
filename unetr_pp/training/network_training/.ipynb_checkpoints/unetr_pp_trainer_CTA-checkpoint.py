...
from unetr_pp.training.network_training.Trainer_CTA import Trainer_CTA
...
from unetr_pp.network_architecture.unetr_pp.next_CTA import UNETR_NEXT
from fvcore.nn import FlopCountAnalysis

# from unetr_pp.network_architecture.unetr_pp.Mstcnet_CTA import MSTCNET
# from unetr_pp.network_architecture.unetr_pp.TCConet import TCCoNet
...
#         self.network = MSTCNET(in_channels=1,out_channels=4,img_size=[128,128,128],do_ds=False)
        
#         self.network = TCCoNet(crop_size=[128, 128, 128],
#                  embedding_dim=192,
#                  input_channels=1,
#                  num_classes=4,
#                  conv_op=nn.Conv3d,
...
#         self.network = MISS_Former(num_classes=4,do_ds=False)
        

#         config = get_hiformer_l_configs()
#         self.network = Hi_Former(config, img_size=224, in_chans=1, n_classes=4, do_ds=False)
        
#         config = get_config()
#         self.network = sstrans(config, img_size=224, num_classes=4, zero_head=False, vis=False, do_ds=False)
