...
from unetr_pp.network_architecture.unetr_pp.dynunet_block import UnetOutBlock, UnetResBlock
from unetr_pp.network_architecture.unetr_pp.model_components import UnetrUpBlock,NextEncoder,NextUpBlock,MHCUpBlock
...
#         depths = [2,2,2,2]
        ...
        self.unetr_pp_encoder = NextEncoder(dims=dims, depths=depths, num_heads=num_heads)
        # print(self.unetr_pp_encoder)
