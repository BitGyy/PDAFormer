...
from pdaformer.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from pdaformer.training.loss_functions.dice_loss import DC_and_CE_loss
from pdaformer.training.network_training.network_trainer_CTA import NetworkTrainer_CTA
...
class Trainer_CTA(NetworkTrainer_CTA):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(Trainer_CTA, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(Trainer_CTA, self).run_training()
    ...
    def get_basic_generators(self):
        self.load_dataset()
        self.do_split()
        # print('basic',self.basic_generator_patch_size)
        # print('patch',self.patch_size)
        print('three',self.threeD)
        if self.threeD:
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(Trainer_CTA, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
