...
import argparse
from pdaformer.preprocessing.preprocessing import resample_data_or_seg
from batchgenerators.utilities.file_and_folder_operations import maybe_mkdir_p
import pdaformer
from pdaformer.run.default_configuration import get_default_configuration
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(pdaformer.__path__[0], "training", "network_training")],
                                                trainerclass,
