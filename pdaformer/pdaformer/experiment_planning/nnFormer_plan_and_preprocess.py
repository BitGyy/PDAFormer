...
from pdaformer.experiment_planning.utils import crop
from pdaformer.paths import *
import shutil
from pdaformer.utilities.task_name_id_conversion import convert_id_to_task_name
from pdaformer.preprocessing.sanity_checks import verify_dataset_integrity
...
def main():
    ...
    search_in = join(pdaformer.__path__[0], "experiment_planning")
